...
class ComplaintsControllerTest < ActionController::TestCase
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post :create, complaint: { key_words: @complaint.key_words, matter: @complaint.matter, subject: @complaint.subject }
    end
  ...
  test "should update complaint" do
    patch :update, id: @complaint, complaint: { key_words: @complaint.key_words, matter: @complaint.matter, subject: @complaint.subject }
    assert_redirected_to complaint_path(assigns(:complaint))
  end
